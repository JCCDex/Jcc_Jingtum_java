...
public enum EngineResult implements SerializedType {
    ...
    telBLKLIST(-392, "Tx disable for blacklist."),
    telINSUF_FUND(-391, "Fund insufficient."),
    ...
    tefPAST_SEQ(-190, "This sequence number has already past."),
    ...
    tecNO_DST(124, "Destination does not exist. Send SWT to create it."),
    tecNO_DST_INSUF_SWT(125, "Destination does not exist. Too little SWT sent to create it."),
